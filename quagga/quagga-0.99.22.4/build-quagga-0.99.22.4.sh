...
# Put conf and init files in the ./misc directory;
# extract quagga-0.99.22.4.tar.gz and olsrd-0.6.6.tar.bz2;
# put this script in the quagga-0.99.22.4 directory;
# cd quagga-0.99.22.4
# then run this script to build and install quagga-0.99.22.4.
...
patch -p1 < ../olsrd-0.6.6/lib/quagga/patches/quagga-0.99.21.diff
